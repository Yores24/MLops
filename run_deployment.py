...
def run_deployment(confi:str,min_accuracy:float):
    ...
    deploy=confi==DEPLOY or confi==DEPLOY_AND_PREDICT
    predict=confi==PREDICT or confi==DEPLOY_AND_PREDICT
    if deploy:
        continuous_deployment_pipeline("D:\MLops\Customer_satisfaction\data\olist_customers_dataset.csv",min_accuracy,3,60,)
